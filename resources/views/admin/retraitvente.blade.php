            ...
            <div class="col-12 grid-margin stretch-card">
                <div class="card">
                  <div class="card-body">
                    ...
                    <form class="forms-sample" method="post" action="{{route('retraitvente')}}">
                      @csrf
                      ...
                      <div class="form-group">
                       ...
                       <label for="exampleInputName1">MONTANT A RETIRER</label>
                     <div class="form-group">
                      ...
                      <button type="submit" class="btn btn-primary me-2">Rétirer</button>
